...
public class TestCase{
	...
	String driverPath=workingDir + "//Resources//geckodriver.exe";
	WebDriver driver;
	WebDriverWait wait;
	public double intPrice;
	String testDataPath= workingDir + "//src//test//java//testData//Test_Data.xlsx";
	...
	public Object[][] getWatchTestData() throws IOException{
